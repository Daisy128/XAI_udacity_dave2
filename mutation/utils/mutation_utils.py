...
from keras.models import Sequential as KES
from keras.models import Model as KEM
...
from mutation.utils.unparse import Unparser
...
def generate_import_nodes(mutation_types):
    ...
    import_nodes.append(
        ast.ImportFrom(module="mutation.utils", names=[
...
def prepare_model(file_path, save_path_prepared, mutation_types):
